...
exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    return knex('jobs').insert([
      {id: 1, title: 'For Jim', description: 'Special Project, see Jim', due_date: '2019-05-25', lane_id: 1, job_type: 2},
      {id: 2, title: 'Blue', description: 'Titanium', due_date: '2019-05-25', lane_id: 1, job_type: 2},
      {id: 3, title: 'Green', description: 'Titanium', due_date: '2019-05-25', lane_id: 1, job_type: 2},
      {id: 4, title: 'Blue', description: 'Steel', due_date: '2019-05-25', lane_id: 2, job_type: 1},
      {id: 5, title: 'Green', description: 'Steel', due_date: '2019-05-25', lane_id: 2, job_type: 1}
    ])
    .then(function () {
